...
`,
    ...
    function addCustomDateRangeMenu(instance) {
        ...
        applyButton.addEventListener('click', function () {
            ...
            } else if (selectedDates.length === 1 || selectedDates[0].getTime() === selectedDates[1].getTime()) {
    ...
    function updateMonthYearHeaders(instance) {
        ...
        monthElements.forEach((monthEl, index) => {
            const monthSelect = monthEl.querySelector('.flatpickr-monthDropdown-months');
            ...
            if (monthSelect && yearInput) {
                ...
                const currentMonthContainer = monthEl.querySelector('.flatpickr-current-month');
